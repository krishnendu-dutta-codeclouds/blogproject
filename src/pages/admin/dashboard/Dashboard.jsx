...
import { SiMinutemailer,SiReact ,SiDevdotto, SiBlogger } from "react-icons/si";
        ...
        <Layout>
            <div className="py-10 mt-20">
                <div
                    ...
                    <div className="left">
                        <img
                            className=" w-60 h-60  object-cover rounded-full border-4 border-indigo-400"
                            src={'https://avatars.githubusercontent.com/u/13141916?v=4'} alt="profile"
                        />
                    </div>
                    <div className="right">
                        <h1
                            className='text-start font-bold text-2xl mb-2 relative'
                            style={{ color: mode === 'dark' ? 'white' : 'rgb(109, 95, 231)' }}
                        >
                            Krishnendu Dutta
                        </h1>
                ...
                {/* Line  */}
                <hr className={`border-2 ${mode === 'dark'
                     ? 'border-gray-300'
                     : 'border-gray-400}`' 
                 }`}
                />
